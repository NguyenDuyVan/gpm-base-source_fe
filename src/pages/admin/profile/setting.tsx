      ...
      <Container fluid>
        <div className="position-relative mx-n4 mt-n4">
          <div className="profile-wid-bg profile-setting-img">
            <img src={progileBg.src} className="profile-wid-img" alt="" />
                  ...
                  <TabPane tabId="4">
                    ...
                    <div>
                      ...
                      <p className="text-muted">
                        ...
                        Account. Scroll to "Your data & privacy options." Delete
                        your Profile Account. Follow the instructions to delete
                        your account :
                      </p>
                      <div>
                        <Input
